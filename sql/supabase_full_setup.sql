...
DROP POLICY IF EXISTS "Service role bypass" ON companies;
DROP POLICY IF EXISTS "Service role bypass" ON users;
DROP POLICY IF EXISTS "Service role bypass" ON clients;
DROP POLICY IF EXISTS "Service role bypass" ON products;
DROP POLICY IF EXISTS "Service role bypass" ON orders;
DROP POLICY IF EXISTS "Service role bypass" ON order_items;
DROP POLICY IF EXISTS "Service role bypass" ON stock_movements;
DROP POLICY IF EXISTS "Service role bypass" ON whatsapp_settings;
DROP POLICY IF EXISTS "Service role bypass" ON logs;
